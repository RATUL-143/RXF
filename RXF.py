...
{uu}  ██   ██ ██   ██  ███ ███ 
\033[1;93m=================================
\033[1;97m Owner  : RATUL x FAHAD
\033[1;97m GitHub : RATUL-143
\033[1;97m Version:\033[1;92m 0.8 \033[1;97m:/
\033[1;97m Status : Privet
...
def check(session,coki):
    ...
    if len(game)==0:
        ...
        for gm in game:
            print(f"\033[1;97m---\033[1;96m"+gm.replace('huwtn',' hxw-code=RXF-33'))
    ...
    if len(game)==0:
        ...
        for gm in game:
            print(f"\033[1;97m---\033[1;93m"+gm.replace('riJan','Hxw-182^)Code=RXF-2233]'))
